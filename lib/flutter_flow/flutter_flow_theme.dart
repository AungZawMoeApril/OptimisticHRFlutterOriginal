...
abstract class FlutterFlowTheme {
  ...
  late Color bkCheckin;
  late Color bkImages;
  late Color timeCheckin;
  late Color f89d27;
  late Color customColor2;
  late Color blackFontColor;
  late Color announcementTitleColor;
  late Color greyTitle;
  late Color overtimetextcolor;
  late Color customColor3;
  late Color regCheckInOutColor;
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFF3F2F7);
  ...
  late Color themeColor = const Color(0xFFFFA500);
  late Color bkCheckin = const Color(0xFFEDEDED);
  late Color bkImages = const Color(0xFFFFF2E3);
  late Color timeCheckin = const Color(0xFF18A32B);
  late Color f89d27 = const Color(0xFF67E1AA);
  late Color customColor2 = const Color(0xFFAD726A);
  late Color blackFontColor = const Color(0xFF000000);
  late Color announcementTitleColor = const Color(0xFF21A8D6);
  late Color greyTitle = const Color(0xFF8A8C8E);
  late Color overtimetextcolor = const Color(0xFF8A8C8E);
  late Color customColor3 = const Color(0xFFA2E629);
  late Color regCheckInOutColor = const Color(0xFF00D57B);
}
