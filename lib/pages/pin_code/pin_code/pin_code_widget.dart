    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      if (FFAppState().isGeneralFirstTime) {
        ...
        if (!FFAppState().isChangePinCodeFlag) {
          ...
          FFAppState().departmentName = getJsonField(
            (_model.apiResultGetPersonalInfo?.jsonBody ?? ''),
            r'''$.data[0].departmentName''',
          ).toString().toString();
          FFAppState().dateOfEmployment = getJsonField(
            (_model.apiResultGetPersonalInfo?.jsonBody ?? ''),
            r'''$.data[0].hiredDate''',
          ).toString().toString();
          FFAppState().hiredDate = getJsonField(
            (_model.apiResultGetPersonalInfo?.jsonBody ?? ''),
            r'''$.data[0].hiredDate''',
          ).toString().toString();
          safeSetState(() {});
            ...
            () async {
              await showDialog(
                ...
                builder: (alertDialogContext) {
                  return WebViewAware(
                    child: AlertDialog(
                      title: Text('Please save pincode for your next login !'),
                      actions: [
                        TextButton(
      ...
      child: WillPopScope(
        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            leading: Visibility(
              visible: FFAppState().isPinCodeFlag,
                                    ...
                                    children: [
                                      Expanded(
                                        child: Container(
                                          ...
                                          height: 20.0,
                                          decoration: BoxDecoration(
                                            color: _model.pinCodeList.length >=
                                                    1
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              InkWell(
                                ...
                                highlightColor: Colors.transparent,
                                onTap: () async {
                                  if (_model.pinCodeList.length >= 0) {
                                    _model.removeFromPinCodeList(
                                        _model.pinCodeList.lastOrNull!);
                                    safeSetState(() {});
                                  }
                                },
                                child: Container(
